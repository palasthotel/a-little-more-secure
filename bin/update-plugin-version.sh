...
# release PR:
#   - public/a-little-more-secure.php  "Version:" header
...
PLUGIN_PHP="$ROOT_DIR/public/a-little-more-secure.php"
...
# ── 1. Update the Version header in a-little-more-secure.php (keeping its alignment) ───
